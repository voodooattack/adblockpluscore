...
const {filterToRegExp, HashMap} = require("./common");
const {defineCompressableField} = require("./compression");

/**
 * All known unique domain sources mapped to their parsed values.
 * @type {Map.<string,Map.<string,boolean>>}
 */
let knownDomainMaps = new HashMap();
...
{
  defineCompressableField(this, "text");
 ...
 */
Filter.knownFilters = new HashMap();
...
Filter.fromText = function(text)
{
  ...
  Filter.knownFilters.set(text, filter);
  return filter;
};
...
function ActiveFilter(text, domains)
{
  ...
  // defineCompressableField(this, "domainSource");
                      ...
                      thirdParty, sitekeys)
{
  ...
  defineCompressableField(this, "pattern");
...
function ContentFilter(text, domains, body)
{
  ...
  defineCompressableField(this, "body");
  this.body = body;
}
