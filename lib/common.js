...
class HashMap extends Map
{
  ...
  get(key)
  {
    return typeof key === "string" ?
        super.get(hashString(key)) : super.get(key);
  }

  set(key, value)
  {
    if (typeof key === "string")
      super.set(hashString(key), value);
    else
      super.set(key, value);
  }
  ...
  {
    return typeof key === "string" ?
        super.has(hashString(key)) : super.has(key);
  }

  delete(key)
  {
    return typeof key === "string" ?
        super.delete(hashString(key)) : super.delete(key);
  }
}
